...
set docinfoF="G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/jre/lib/resource/docInfo.xml"
set resourcdDir="G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/resource"
set srcDirs="G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/resource/output/EN"
set xslDir=%resourcdDir%/xsls
set tempDir="G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/srcDir/temp"
set excelTemplsDir="G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/srcDir/temp/excelTempls"



rem rem rem rem rem rem *************************************************************
java %transform%  -s:"G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/srcDir/temp/eachSrc/RAC113-00_IB_23Y AR9500T 무풍GEO_EU_EN-WEB_230821_ar-SA.xml"  -o:%tempDir%\00-messageF-groupLang.xml  -xsl:%xslDir%\01-messageF-groupLang.xsl docinfoF=%docinfoF%
rem java %transform%  -s:%xslDir%\dummy.xml  -o:%tempDir%\00-videolinkF-group.xml  -xsl:%xslDir%\01-videolinkF-group.xsl
rem java %transform%  -s:"G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/srcDir/temp/eachSrc/aaa.xml"  -o:%tempDir%\01-simplify.xml  -xsl:%xslDir%\01-simplify.xsl
