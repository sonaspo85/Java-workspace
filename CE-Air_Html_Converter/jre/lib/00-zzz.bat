...
rem java %transform%  -s:"G:/MS-Drive/OneDrive - UOU/WORK/Workspace/WORK/JAVA/java-workspace/CE-Air_Html_Converter/srcDir/temp/eachSrc/RAC113-00_IB_23Y AR9500T GEO_EU_EN-WEB_.xml"  -o:%tempDir%\00-messageF-groupLang.xml  -xsl:%xslDir%\01-messageF-groupLang.xsl docinfoF=%docinfoF%
