        ...
        <root>
            ...
            <xsl:for-each select="doc">
                ...
                <xsl:copy>
                    ...
                    <xsl:attribute name="fileName" select="'buds-sars2'" />
                    <xsl:apply-templates select="@*" />
                            ...
                            <xsl:variable name="specLang">
                                <xsl:choose>
                                    <xsl:when test="$Product = 'Hearable'">
                                        <xsl:copy-of select="$langXML/buds-sars/items[@lang = $lang]/item[@id='body-wornsar']" />
                                    </xsl:when>
                                    
                                    <xsl:otherwise>
                                        <xsl:copy-of select="$langXML/sars/items[@lang = $lang]/item[@id='limbsar1']" />
                                    </xsl:otherwise>
                                </xsl:choose>
                            </xsl:variable>
