...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-9.9.1-4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\ant-apache-resolver-1.10.6.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.9.9.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.9.9.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.9.9.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\snakeyaml-1.23.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\batik-all-1.12.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fontbox-2.0.17.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-2.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-pdf-images-2.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\jcl-over-slf4j-1.7.25.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\pdfbox-2.0.17.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\slf4j-api-1.7.25.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\xmlgraphics-commons-2.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.xep\lib\xep.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.lwdita\lib\org.lwdita-2.3.2.jar;%CLASSPATH%
