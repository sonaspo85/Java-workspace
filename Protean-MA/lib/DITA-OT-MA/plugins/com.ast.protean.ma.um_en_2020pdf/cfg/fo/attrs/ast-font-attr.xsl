...
<xsl:stylesheet
    ...
    <xsl:template name="fontSize">
        ...
        <xsl:if test="matches($cur, 'HeaderHeading')">
            <xsl:call-template name="getVariable">
                <xsl:with-param name="id" select="concat('HeaderHeading', ' Size')" />
            </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="matches($class, 'topic/p ')">
            <xsl:choose>
                ...
                <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/p', ' Size')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'hi-d/b ')">
            <xsl:choose>
                <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/b', ' Size')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'topic/ph ') and
            ...
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@outputclass, 'intuitive1')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive1)', ' topic/ph', ' Size')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive2')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive2)', ' topic/ph', ' Size')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive3')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive3)', ' topic/ph', ' Size')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'fillarrow')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=fillarrow)', ' topic/ph', ' Size')" />
                    </xsl:call-template>
                </xsl:when>
    ...
    <xsl:template name="fontFamily">
        ...
        <xsl:if test="matches($class, 'topic/p ')">
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@outputclass, 'footnote')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=footnote)', ' topic/p', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'topic/ph ') and
            ...
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@outputclass, 'intuitive1')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive1)', ' topic/ph', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive2')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive2)', ' topic/ph', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive3')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive3)', ' topic/ph', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'fillarrow')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=fillarrow)', ' topic/ph', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'task/step ')">
            <xsl:choose>
                <!-- <xsl:when test="matches($OSname, '-OS_upgrade') and
                    ...
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('OS_Upgrade)', ' task/step', ' FontFamily')" />
                    </xsl:call-template>
                </xsl:when> -->
        ...
        <xsl:if test="matches($class, 'topic/li ') and
            ...
            <xsl:call-template name="getVariable">
                <!-- <xsl:with-param name="id" select="concat('li-Bullet)', ' topic/li', ' FontFamily')" /> -->
                <xsl:with-param name="id" select="concat($cur, ')', ' topic/li', ' FontFamily')" />
            </xsl:call-template>
        </xsl:if>
    ...
    <xsl:template name="fontColor">
        ...
        <xsl:if test="matches($class, 'topic/xref ')">
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@format, 'email')]">
                    <xsl:value-of select="'cmyk(0%,0%,0%,100%)'" />
                </xsl:when>
    ...
    <xsl:template name="lineHeight">
        ...
        <xsl:if test="matches($class, 'topic/p ')">
            <xsl:choose>
                ...
                <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/p', ' LineHeight')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'topic/ph ') and
            ...
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@outputclass, 'intuitive1')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive1)', ' topic/ph', ' LineHeight')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive2')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive2)', ' topic/ph', ' LineHeight')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive3')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive3)', ' topic/ph', ' LineHeight')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'fillarrow')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=fillarrow)', ' topic/ph', ' LineHeight')" />
                    </xsl:call-template>
                </xsl:when>
    ...
    <xsl:template name="fontStretch">
        ...
        <xsl:if test="matches($class, 'topic/p ')">
            <xsl:choose>
                <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/p', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'footnote')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=footnote)', ' topic/p', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>
        ...
        <xsl:if test="matches($class, 'topic/ph ') and
            ...
            <xsl:choose>
                ...
                <xsl:when test="$cur[matches(@outputclass, 'intuitive1')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive1)', ' topic/ph', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive2')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive2)', ' topic/ph', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'intuitive3')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=intuitive3)', ' topic/ph', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>

                <xsl:when test="$cur[matches(@outputclass, 'fillarrow')]">
                    <xsl:call-template name="getVariable">
                        <xsl:with-param name="id" select="concat('outputclass=fillarrow)', ' topic/ph', ' FontStretch')" />
                    </xsl:call-template>
                </xsl:when>
            ...
            <xsl:otherwise>
                ...
                <xsl:if test="matches($class, 'topic/p ')">
                    <xsl:choose>
                        ...
                        <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/p', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>

                        <xsl:when test="$cur[matches(@outputclass, 'footnote')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=footnote)', ' topic/p', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>
                ...
                <xsl:if test="matches($class, 'hi-d/b ')">
                    <xsl:choose>
                        ...
                        <xsl:when test="ancestor::*[matches(@outputclass, 'table_text_tur_address')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=spec_address)', ' topic/b', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>
                ...
                <xsl:if test="matches($class, 'topic/ph ') and
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="$cur[matches(@outputclass, 'intuitive1')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=intuitive1)', ' topic/ph', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>

                        <xsl:when test="$cur[matches(@outputclass, 'intuitive2')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=intuitive2)', ' topic/ph', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>

                        <xsl:when test="$cur[matches(@outputclass, 'intuitive3')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=intuitive3)', ' topic/ph', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>

                        <xsl:when test="$cur[matches(@outputclass, 'fillarrow')]">
                            <xsl:call-template name="getVariable">
                                <xsl:with-param name="id" select="concat('outputclass=fillarrow)', ' topic/ph', ' LetterSpacing')" />
                            </xsl:call-template>
                        </xsl:when>
