...
--> 
    ...
    <xsl:template name="processAttrSetReflection">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$attrSet = '__tableframe__all'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="__tableframe__all"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            ...
            <xsl:when test="$attrSet = 'table__tableframe__thin__topbot'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="table__tableframe__thin__topbot"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
