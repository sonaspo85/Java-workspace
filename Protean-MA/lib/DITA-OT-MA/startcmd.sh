...
NEW_CLASSPATH="$DITA_DIR/lib/jackson-annotations-2.13.4.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-core-2.13.4.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-databind-2.13.4.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-dataformat-yaml-2.13.4.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/snakeyaml-1.31.jar:$NEW_CLASSPATH"
