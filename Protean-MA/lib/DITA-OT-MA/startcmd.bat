...
set CLASSPATH=%DITA_DIR%lib\jackson-annotations-2.13.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.13.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.13.4.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.13.4.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\snakeyaml-1.31.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.lwdita\lib\org.lwdita-2.4.0.jar;%CLASSPATH%
